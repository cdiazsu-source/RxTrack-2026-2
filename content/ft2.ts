...
export const ft2: SubjectContent = {
  ...
  modules: [
    ...
    },
    {
      ...
      chapter: [
        "#### Por qué después de los tensioactivos viene esto",
        "",
        "En el Módulo 2 viste que, por encima de la Concentración Micelar Crítica (CMC — la concentración mínima a la que un tensioactivo empieza a formar micelas), los tensioactivos se agregan en estructuras de tamaño **nanométrico**: micelas, vesículas, cristales líquidos. Esas estructuras son, en realidad, el primer ejemplo que viste de algo mucho más general: un **sistema coloidal**. Este módulo retoma esa idea y la amplía a cualquier partícula (no solo tensioactivos) que caiga en ese rango de tamaño, y añade dos herramientas nuevas para describir su comportamiento: sus **propiedades eléctricas** (por qué dos partículas se repelen o se atraen) y su **reología** (cómo fluye o se resiste a fluir el sistema completo). Ambas herramientas son, literalmente, la teoría detrás de las Prácticas 3 y 4 de laboratorio.",
        "",
        "#### ¿Qué es, otra vez, un sistema coloidal?",
        "",
        "En el Módulo 1 clasificaste los sistemas dispersos por tamaño de partícula en tres categorías. La del medio —la **dispersión coloidal**— agrupa partículas de aproximadamente **1 nanómetro (nm, una millonésima de milímetro) a 1 micrómetro (µm, una milésima de milímetro)**. Es un tamaño curioso: lo bastante grande para tener una interfase real (una frontera física con el medio que lo rodea, a diferencia de una molécula disuelta), pero lo bastante pequeño para ser invisible a un microscopio óptico normal y para no sedimentar por gravedad de forma inmediata como sí lo hace la arena. Todo lo que vas a ver en este módulo —cómo se ve, cómo se mueve, cómo se repele o se agrega, cómo fluye el sistema que lo contiene— es consecuencia directa de vivir justo en ese rango de tamaño intermedio.",
        "",
        "#### Tres grandes familias de coloides",
        "",
        "* **Coloides liofílicos** (\"que aman al disolvente\"): tienen afinidad química real por el medio que los dispersa y se dispersan **espontáneamente**, sin necesitar ayuda externa — por ejemplo, polímeros hidrófilos o gomas naturales en agua. Son termodinámicamente más estables.",
        "* **Coloides liofóbicos** (\"que le temen al disolvente\"): no tienen afinidad por el medio; hay que dispersarlos por la fuerza (agitación, molienda) y, sin ayuda adicional, tienden a agregarse y separarse del medio con el tiempo — por ejemplo, muchos sólidos inorgánicos insolubles dispersos en agua, como el subnitrato de bismuto de la Práctica 3.",
        "* **Coloides de asociación**: no son partículas sólidas, sino agregados que se forman **espontáneamente** cuando moléculas anfifílicas (con una parte que ama el agua y otra que la evita) superan una concentración crítica. Ya los conoces: son exactamente las micelas, vesículas y cristales líquidos del Módulo 2.",
        "",
        "> Analogía: un coloide liofílico es como alguien que llega a una fiesta y se integra solo, sin que nadie tenga que presentarlo — encaja de forma natural. Un coloide liofóbico es como alguien que hay que arrastrar a la fiesta y que, en cuanto lo sueltas, busca la salida o se junta con los pocos conocidos que tiene (se agrega). Un coloide de asociación es distinto a los dos: no es una persona que ya estaba ahí, es un grupo que se forma espontáneamente en medio de la fiesta cuando hay suficiente gente con un interés en común (como viste con las micelas: se forman solas al superar la CMC).",
        "",
        "#### Cómo \"vemos\" un coloide sin verlo: propiedades ópticas",
        "",
        "Una partícula coloidal es demasiado pequeña para verse directamente con luz visible, pero no es invisible en otro sentido: **dispersa la luz**. Si haces pasar un haz de luz de lado (perpendicular a tu línea de visión) a través de una dispersión coloidal en un cuarto oscuro, vas a ver el trayecto completo del haz iluminado, como un cono de luz brillante atravesando el líquido — eso se llama **efecto Tyndall**. Una solución verdadera (moléculas disueltas, sin interfase) no hace esto: el haz de luz la atraviesa sin volverse visible, porque no hay partículas lo bastante grandes para dispersar la luz en todas direcciones.",
        "",
        "> Analogía: es exactamente el mismo fenómeno que ves cuando un rayo de sol entra por una ventana a un cuarto con polvo en el aire — no ves el polvo en sí (las partículas son demasiado pequeñas y están demasiado lejos de tus ojos), pero sí ves el haz de luz completo, iluminado, porque cada partícula de polvo dispersa un poco de esa luz hacia tus ojos. El aire limpio (sin partículas) no hace eso: el rayo de sol es invisible hasta que toca una superficie.",
        "",
        "#### El baile incesante: propiedades cinéticas",
        "",
        "Si observas una partícula coloidal bajo un microscopio (con la iluminación lateral del efecto Tyndall), no la ves quieta: se mueve en zigzag, de forma errática y constante. Ese movimiento se llama **movimiento browniano**, y su causa es simple: las moléculas del medio (por ejemplo, agua) están en constante agitación térmica y chocan contra la partícula coloidal desde todas direcciones, al azar. La mayor parte del tiempo esos choques se cancelan entre sí (llegan más o menos parejos desde todos los lados), pero en cualquier instante hay un pequeño desbalance neto que empuja a la partícula en una dirección — y al instante siguiente, en otra.",
        "",
        "> Analogía: piensa en un globo grande flotando en medio de una multitud que lo empuja al azar desde todos los ángulos, sin ponerse de acuerdo. El globo no avanza en línea recta hacia ningún lado: se sacude erráticamente, un poco hacia donde el empujón del momento fue más fuerte. Ese es el movimiento browniano.",
        "",
        "Este \"baile\" no es solo una curiosidad: es lo que evita que las partículas coloidales más pequeñas sedimenten de inmediato aunque sean más densas que el medio — el zarandeo browniano contrarresta, a esa escala diminuta, el efecto de la gravedad. Cuanto más grande es la partícula (ya en el rango de las dispersiones groseras, como la arena de la Práctica 4), menos la afecta este zarandeo relativo a su propio peso, y por eso sedimenta de forma mucho más predecible y notoria.",
        "",
        "#### La armadura invisible: propiedades eléctricas y la doble capa eléctrica",
        "",
        "La mayoría de las partículas coloidales dispersas en un líquido tienen carga eléctrica neta en su superficie (por ionización de grupos superficiales, o por adsorción de iones del medio — como viste en la Práctica 3 con el propilenglicol y, sobre todo, con los tensioactivos cargados del Módulo 2). Esa carga superficial atrae hacia sí una nube de iones de carga contraria (contraiones) del medio que la rodea, organizada en dos regiones:",
        "",
        "* Una **capa fija (o de Stern)**: contraiones fuertemente adheridos, casi pegados a la superficie de la partícula — el mismo concepto de \"capa de Stern\" que ya viste alrededor de una micela en el Módulo 2, aplicado ahora a cualquier partícula cargada.",
        "* Una **capa difusa**: contraiones adicionales, más libres, cuya concentración disminuye gradualmente a medida que te alejas de la partícula hasta igualar la del seno de la solución.",
        "",
        "A esta organización completa (superficie cargada + capa fija + capa difusa) se le llama **doble capa eléctrica**. En algún punto dentro de la capa difusa, donde el líquido empieza a moverse libremente respecto a la partícula (el \"plano de deslizamiento\"), se mide un potencial eléctrico llamado **potencial zeta**: en la práctica, es la medida de qué tan fuerte se repelen entre sí dos partículas iguales que se acercan.",
        "",
        "> Analogía: piensa en cada partícula coloidal cargada como si llevara puesto un imán, rodeado por una nube de limaduras de hierro de polaridad opuesta pegadas muy cerca (capa fija) y otra nube de limaduras más sueltas, más lejos, que se van dispersando (capa difusa). Si dos partículas con la misma polaridad de imán se acercan, se repelen — mientras más fuerte el imán efectivo que \"se siente\" desde afuera (el potencial zeta), más se repelen y más dispersa se mantiene la suspensión.",
        "",
        "Esta es exactamente la física detrás de la Práctica 3: añadir un electrolito de **carga opuesta** a la de la partícula introduce contraiones que se meten en esa doble capa y **apantallan** (neutralizan parcialmente) la carga superficial — el \"imán efectivo\" se debilita, el potencial zeta baja, la repulsión entre partículas disminuye y el sistema **flocula** (las partículas se agregan en grupos laxos). Un electrolito de la **misma carga**, en cambio, no apantalla nada — mantiene o incluso refuerza la repulsión, y el sistema permanece **disperso**. Como regla general (regla de Schulze-Hardy, un principio clásico de la química coloidal), entre más alta la carga del contraión que se añade, **menor** es la concentración de electrolito necesaria para producir floculación — por eso en la Práctica 3 comparas NaCl (contraión monovalente), AlCl₃ (contraión trivalente) y Na₂HPO₄ (anión divalente): no todos necesitan la misma cantidad para lograr el mismo efecto.",
        "",
        "#### Qué tan rápido cae: sedimentación y la ley de Stokes",
        "",
        "Una partícula dispersa que es más densa que el medio que la rodea, tarde o temprano sedimenta por gravedad — la pregunta es qué tan rápido. Para partículas esféricas, diluidas y en flujo laminar (sin turbulencia), la velocidad terminal de sedimentación la describe la **ley de Stokes**:",
        "",
        "```formula",
        "v = #{d^{2}(ρ_{s} − ρ_{l})·g|18·η}",
        "```",
        "",
        "Fíjate en dos cosas clave de esta ecuación. Primero, la velocidad depende del **diámetro al cuadrado**: si duplicas el tamaño de una partícula, no sedimenta el doble de rápido, sino **cuatro veces** más rápido — el tamaño de partícula es, con diferencia, la variable más influyente. Segundo, la velocidad es **inversamente proporcional a la viscosidad** del medio (η): un medio más viscoso frena la sedimentación de cualquier partícula, sin importar su tamaño — la razón exacta por la que, en la Práctica 4, la misma arena sedimenta más lento en una dispersión de carboximetilcelulosa (CMC, un polímero espesante hidrosoluble muy usado como agente suspensor — no confundir con la CMC del Módulo 2, la concentración micelar crítica: son dos siglas iguales para dos conceptos completamente distintos) que en agua sola.",
        "",
        "> Analogía: suelta una canica de acero en un vaso de agua y otra igual en un vaso de miel — la de la miel cae muchísimo más lento, porque el medio es más viscoso (η más alta). Ahora suelta dos canicas de acero del mismo material pero de distinto tamaño en el mismo vaso de agua — la canica grande llega al fondo notablemente más rápido, y no de forma proporcional a cuánto más grande es, sino al cuadrado de esa diferencia.",
        "",
        "#### La reología: cómo fluyen los sistemas",
        "",
        "La **reología** es, literalmente, el estudio de cómo fluyen y se deforman los materiales bajo un esfuerzo. Su variable central es la **viscosidad**: la resistencia interna de un fluido a fluir. El agua tiene una viscosidad baja y constante sin importar qué tan fuerte la agites o la fuerces a fluir — eso la convierte en un fluido **newtoniano** (su viscosidad no cambia con la velocidad de cizalla, la rapidez con la que se deforma). La mayoría de las formulaciones farmacéuticas reales, en cambio, son **no newtonianas**: su viscosidad cambia según qué tan fuerte y rápido las fuerces a fluir. Las variantes más comunes:",
        "",
        "* **Pseudoplástico** (*shear-thinning*, \"se adelgaza al esfuerzo\"): la viscosidad **baja** entre más rápido lo agitas o lo fuerzas a fluir. El kétchup es el ejemplo clásico: quieto en la botella parece casi sólido, pero al agitarlo o presionarlo fluye con facilidad.",
        "* **Dilatante** (*shear-thickening*, \"se espesa al esfuerzo\"): justo lo contrario — la viscosidad **sube** entre más fuerte lo agitas. La mezcla de maicena con agua en proporción alta es el ejemplo típico: se comporta casi como líquido si la tocas con suavidad, pero se pone rígida como un sólido si la golpeas.",
        "* **Plástico (o de Bingham)**: se comporta como un sólido rígido (no fluye en absoluto) hasta que el esfuerzo aplicado supera un umbral mínimo (el *esfuerzo de cedencia*); superado ese umbral, empieza a fluir. La pasta dental es el ejemplo cotidiano: mantiene su forma en el tubo y sobre el cepillo hasta que aplicas la presión suficiente para que fluya.",
        "",
        "#### Cuando el tiempo también importa: tixotropía y reopexia",
        "",
        "Hasta ahora, la viscosidad dependía solo de *qué tan fuerte* la esfuerzas. La **tixotropía** añade una variable más: el **tiempo**. Un sistema tixotrópico pierde viscosidad de forma progresiva mientras se mantiene bajo un esfuerzo de cizalla constante (no de golpe, sino gradualmente con el tiempo de agitación), y la recupera gradualmente también, en reposo. Muchas suspensiones farmacéuticas se formulan a propósito para ser tixotrópicas: en el frasco, en reposo, son lo bastante viscosas para mantener las partículas suspendidas sin sedimentar rápido; al agitarlas (justo antes de usarlas, como indica la etiqueta de \"agítese bien antes de usar\") se vuelven fluidas y fáciles de verter o dosificar; y en cuanto dejas de agitar, recuperan su viscosidad de reposo.",
        "",
        "> Analogía: es el mismo comportamiento de una pintura espesa de buena calidad — al removerla con la paleta se afloja progresivamente y se vuelve fácil de aplicar, pero si la dejas quieta unos minutos, recupera su espesor original.",
        "",
        "La **reopexia** es el fenómeno opuesto y mucho más raro: la viscosidad **aumenta** de forma progresiva mientras el sistema se somete a un esfuerzo de cizalla constante en el tiempo.",
        "",
        "#### Cuando algo es medio líquido y medio sólido: viscoelasticidad",
        "",
        "Algunos sistemas (muchos geles y semisólidos, que verás en detalle en el Módulo 6) no son puramente viscosos (como un líquido) ni puramente elásticos (como un sólido que recupera su forma al instante), sino una combinación de ambos: **viscoelásticos**. Ante una fuerza breve se comportan de forma elástica (se deforman y recuperan su forma), pero ante una fuerza sostenida en el tiempo fluyen de forma progresiva, como un líquido viscoso.",
        "",
        "> Analogía: la plastilina blanda (o un slime casero) es el ejemplo perfecto. Si la golpeas rápido, rebota como una pelota (comportamiento elástico, casi sólido). Si la dejas reposar sobre una mesa inclinada, con el tiempo se va escurriendo y aplanando como un líquido muy espeso (comportamiento viscoso). Es, literalmente, las dos cosas a la vez, según cuánto tiempo dura la fuerza aplicada.",
        "",
        "#### Añadir partículas también cambia la viscosidad: la ecuación de Einstein",
        "",
        "Incluso sin ningún efecto eléctrico ni tixotrópico, el simple hecho de dispersar partículas sólidas rígidas dentro de un líquido ya sube su viscosidad, porque cada partícula perturba las líneas de flujo del líquido a su alrededor. Para una suspensión diluida de esferas rígidas, este efecto lo describe la **ecuación de Einstein**:",
        "",
        "```formula",
        "η = η_{0}(1 + 2.5φ)",
        "```",
        "",
        "Donde η₀ es la viscosidad del medio puro y φ es la fracción del volumen total ocupada por las partículas dispersas. Es la razón física de fondo por la que, en la Práctica 5 (capacidad suspensora), aumentar la concentración de la fase dispersa sólida sube la viscosidad de la suspensión incluso antes de considerar el efecto de ningún agente suspensor añadido.",
        "",
        "#### Cómo se conecta todo esto con las Prácticas 3 y 4",
        "",
        "La Práctica 3 es, de principio a fin, una demostración experimental de la **doble capa eléctrica** y el **potencial zeta**: cómo la carga de la partícula (natural, o \"comunicada\" con un tensioactivo cargado en la actividad 3B) y la carga de los electrolitos que le añades determinan si el sistema flocula o se dispersa, medido indirectamente a través del volumen de sedimento, su compactación y la facilidad de redispersión. La Práctica 4 es una demostración experimental de la **ley de Stokes**: cómo el tamaño de partícula (actividad 4A, ligado además a la vía de administración) y la viscosidad del medio (actividad 4B, agua vs. dispersión de carboximetilcelulosa) determinan la velocidad de sedimentación. Ambas prácticas convierten en números y observaciones medibles la teoría de este capítulo.",
        "",
        "#### En resumen",
        "",
        "* Un **sistema coloidal** tiene partículas de 1 nm a 1 µm: con interfase real, pero invisibles al microscopio óptico.",
        "* Se clasifica en **liofílico** (afinidad espontánea por el medio), **liofóbico** (requiere dispersión forzada) y **de asociación** (micelas, vesículas — se forman solas sobre la CMC).",
        "* Sus propiedades **ópticas** (efecto Tyndall), **cinéticas** (movimiento browniano) y **eléctricas** (doble capa eléctrica, potencial zeta) explican cómo se ve, se mueve y se repele/agrega un coloide.",
        "* La **ley de Stokes** predice la velocidad de sedimentación: crece con el cuadrado del diámetro y baja al subir la viscosidad del medio.",
        "* La **reología** describe cómo fluye el sistema completo: newtoniano vs. no newtoniano (pseudoplástico, dilatante, plástico), **tixotropía**/reopexia (dependencia del tiempo) y **viscoelasticidad** (mitad líquido, mitad sólido).",
        "* La ecuación de **Einstein** muestra que incluso sin efectos eléctricos, más partículas dispersas = más viscosidad.",
        "* Las Prácticas 3 y 4 son la comprobación experimental directa de la doble capa eléctrica y de la ley de Stokes, respectivamente.",
      ].join("\n"),
    },
    {
      slug: "suspensiones",
  ...
  labPractices: [
...

    {
      ...
      desarrollo: [
        "#### Qué vas a hacer, en una frase",
        "",
        "Vas a tomar el mismo sólido (subnitrato de bismuto (III), una sal de bismuto insoluble en agua) y dispersarlo en probetas idénticas, añadiendo a cada una un volumen creciente de un electrolito distinto — y luego vas a medir, con una regla y un cronómetro, si ese electrolito hizo que las partículas se **junten** (floculen) o se **mantengan separadas** (dispersen). La actividad 3B repite la idea, pero primero le \"presta\" una carga eléctrica a un sólido que naturalmente no la tiene (el azufre), usando un tensioactivo cargado como humectante.",
        "",
        "#### Contexto: por qué esto no es solo \"echar sal y ver qué pasa\"",
        "",
        "Como viste en el marco teórico de este módulo, una partícula sólida dispersa en agua casi nunca está eléctricamente neutra: tiene una carga superficial que atrae una nube de contraiones a su alrededor — la doble capa eléctrica. Esa carga es lo único que evita que las partículas, que están en constante movimiento browniano y chocando entre sí al azar, se peguen unas a otras cada vez que se tocan: si todas tienen carga del mismo signo, se repelen justo antes del contacto, como dos imanes enfrentados por el mismo polo, y el sistema se mantiene disperso (partículas individuales, suspendidas, sedimentando lento).",
        "",
        "> Analogía central de la práctica: imagina que cada partícula de subnitrato de bismuto lleva puesto un chaleco con un imán, todos con el mismo polo hacia afuera. Mientras todos los chalecos tengan el mismo polo expuesto, las partículas se repelen entre sí y flotan separadas, como personas que se evitan en una sala. Si le acercas a cada una un imán de polo **contrario** (un electrolito de carga opuesta a la del sólido), ese imán externo neutraliza parcialmente el chaleco — las partículas dejan de \"sentir\" la repulsión de las demás, se acercan, y como ya no hay nada empujándolas aparte, se **pegan en grupos** (flóculos). Si en cambio le acercas un imán del **mismo polo** (electrolito de igual carga), no cambia nada — o incluso refuerza la repulsión — y las partículas se quedan cada una por su lado.",
        "",
        "#### Fundamento, un poco más profundo",
        "",
        "Cuando dos partículas cargadas del mismo signo se acercan, compiten dos fuerzas: la atracción de van der Waals (que existe siempre, entre cualquier par de partículas cercanas, y las jala a unirse) y la repulsión electrostática de sus dobles capas (que las empuja a separarse). Mientras el potencial zeta —la \"fuerza\" efectiva de esa repulsión, medida en el borde de la doble capa— sea alto, la repulsión gana y el sistema se mantiene disperso. Un electrolito de carga opuesta introduce contraiones que se acomodan dentro de la doble capa de la partícula y **apantallan** su carga superficial: el potencial zeta baja, la repulsión se debilita, y en algún punto la atracción de van der Waals empieza a ganar — ahí es cuando ves floculación. Cuantos más iones de carga opuesta tenga cada molécula del electrolito (su **valencia**: NaCl aporta un solo Na⁺ o Cl⁻ por molécula, AlCl₃ aporta un Al³⁺ con carga triple), más eficiente es apantallando esa carga, y por eso se necesita **menos concentración** de un electrolito de mayor valencia para lograr el mismo efecto (regla de Schulze-Hardy).",
        "",
        "La actividad 3B añade una vuelta más: el azufre, por sí solo, es un sólido prácticamente neutro (sin carga superficial relevante) — así que ningún electrolito debería tener mucho efecto sobre él directamente. Pero si antes lo humectas con un tensioactivo **cargado** (Aerosol OT, aniónico, o cloruro de benzalconio, catiónico), ese tensioactivo se adsorbe en la superficie del azufre y le \"presta\" su carga — ahora el azufre se comporta, eléctricamente, como si tuviera la carga del tensioactivo. A partir de ahí, la lógica es exactamente la misma que en la 3A: un electrolito de carga opuesta a la carga prestada flocula; uno de la misma carga, no (o dispersa aún más).",
        "",
        "#### Resultado esperado",
        "",
        "En la actividad 3A, la muestra sin electrolito (BL) debería mostrarte el comportamiento \"por defecto\" del subnitrato de bismuto — normalmente un sólido con cierta carga superficial (a menudo negativa en agua, aunque el signo exacto depende de la química de la superficie). Deberías ver que uno de los tres electrolitos (el de carga opuesta al sólido) produce, a medida que aumenta el volumen añadido, un sedimento cada vez **más voluminoso, más suelto y más fácil de redispersar** (menos vueltas de 180° necesarias) que el blanco — eso es floculación creciente. Los electrolitos de la misma carga deberían dar sedimentos parecidos o incluso más compactos y difíciles de redispersar que el blanco. Y si comparas AlCl₃ (contraión trivalente) contra NaCl (contraión monovalente), el AlCl₃ debería lograr un efecto floculante notorio con **menos volumen añadido** que el NaCl, por su mayor valencia.",
        "",
        "En la actividad 3B, espera un patrón \"cruzado\": para el azufre humectado con Aerosol OT (carga aniónica prestada), el electrolito que contiene el catión (Ca²⁺, en el CaCl₂) debería flocular con más fuerza que el que aporta un anión adicional (Na₂HPO₄). Para el azufre humectado con cloruro de benzalconio (carga catiónica prestada), el patrón debería invertirse: el Na₂HPO₄ (con su anión) debería flocular más que el CaCl₂. Si ves ese patrón cruzado, confirma exactamente la teoría: lo que flocula no es \"el electrolito\" en abstracto, sino específicamente el ion de carga **opuesta** a la que tiene (o adquirió) la partícula.",
      ].join("\n"),
      keyPoints: [
...

    {
      ...
      desarrollo: [
        "#### Qué vas a hacer, en una frase",
        "",
        "En la actividad 4A vas a **medir** (no asumir) el tamaño real de partícula de productos comerciales ya formulados, y a comparar ese dato contra lo que la literatura dice que debería ser según su vía de administración. En la 4B vas a tomar arena tamizada en distintos rangos de tamaño y cronometrar cuánto tarda cada rango en sedimentar, primero en agua y luego en un medio más viscoso — para comprobar con tus propios datos, en un sistema controlado y simple, lo que predice la ley de Stokes.",
        "",
        "#### Contexto: por qué el tamaño de partícula no es un detalle técnico menor",
        "",
        "El tamaño de partícula de un sólido disperso no es solo un número de calidad en una ficha técnica: es, muchas veces, la diferencia entre un producto seguro y uno peligroso. Una suspensión **oftálmica** (gotas para los ojos) necesita partículas extremadamente finas: una partícula demasiado grande puede rayar la córnea, un tejido muy sensible, cada vez que el párpado parpadea sobre ella. Una suspensión **parenteral** (inyectable) es aún más estricta: si una partícula es más grande que el capilar sanguíneo más estrecho por el que tiene que pasar, puede **obstruirlo** (una embolia) — ahí el tamaño de partícula es, literalmente, un asunto de vida o muerte, no de estética del producto. Las suspensiones **orales** y **tópicas** son bastante más tolerantes: ahí el tamaño de partícula importa sobre todo para la textura, la velocidad de disolución del fármaco y qué tan rápido sedimenta el producto en el frasco.",
        "",
        "> Analogía: piensa en la diferencia entre que te caiga en el ojo una gota de agua con polvo finísimo de talco (apenas lo notas, quizás ni parpadees) frente a que te caiga arena de playa (te duele y te hace parpadear de inmediato, posible rasguño). Esa diferencia de \"tolerancia al tamaño de partícula\" según el tejido que la recibe es exactamente el criterio que usa la industria para decidir qué tan fino tiene que estar molido o micronizado un principio activo según la vía por la que se va a administrar.",
        "",
        "#### Fundamento, un poco más profundo: por qué el tamaño pesa tanto en la sedimentación",
        "",
        "Ya viste la ley de Stokes en el marco teórico del módulo: v = d²(ρₛ − ρₗ)·g / 18·η. La razón física detrás del exponente al cuadrado es geométrica: al duplicar el diámetro de una esfera, su **peso** (proporcional al volumen, que crece con el cubo del radio) aumenta mucho más rápido que la **resistencia por fricción** que el líquido opone a su caída (proporcional, para una esfera, solo al radio, no al área ni al volumen). El resultado neto de esa carrera desigual entre peso y fricción es que la velocidad terminal de sedimentación termina dependiendo del diámetro elevado al cuadrado. Por eso, en la actividad 4B, no vale la pena tratar de \"adivinar\" la relación entre tamaño y velocidad a ojo — hay que medirla y graficarla, porque no es una relación lineal simple, sino cuadrática.",
        "",
        "La segunda mitad de la ecuación —la viscosidad del medio (η) en el denominador— es la que pone a prueba la actividad 4B con el cambio de agua a dispersión de carboximetilcelulosa (CMC, un polímero hidrosoluble usado como agente espesante/suspensor; no confundir con la otra CMC del Módulo 2, la concentración micelar crítica). Al subir la viscosidad del medio, **toda** partícula sedimenta más lento, sin importar su tamaño — el efecto de la viscosidad y el efecto del tamaño son dos \"palancas\" independientes de la misma ecuación, y esta práctica te deja mover ambas por separado.",
        "",
        "> Analogía: imagina dejar caer bolitas de distinto tamaño, todas del mismo material, primero en un tubo lleno de agua y luego en un tubo idéntico lleno de un jarabe espeso. Dentro de cada tubo, la bolita más grande siempre le gana la carrera a la más pequeña, y esa ventaja se agranda mucho más de lo que esperarías solo por ser \"un poco más grande\" (el efecto del cuadrado). Pero además, la misma bolita, en el tubo con jarabe, tarda mucho más en llegar al fondo que en el tubo con agua — el medio más viscoso frena a todas las bolitas por igual, grandes y pequeñas.",
        "",
        "#### Resultado esperado",
        "",
        "En la actividad 4A, espera que los productos formulados para vías más delicadas (oftálmica, y sobre todo parenteral) muestren, al medirlos, un tamaño de partícula sistemáticamente **menor** que los formulados para vías más tolerantes (oral, tópica, industrial) — si el fabricante cumplió con los requisitos de calidad esperados para cada vía. Un tamaño medido muy por encima de lo que la literatura reporta como aceptable para esa vía sería una señal de alerta de calidad (o, más probablemente en el contexto de la práctica, una señal de que el producto elegido para comparar no era el más adecuado para esa vía específica).",
        "",
        "En la actividad 4B, al graficar velocidad de sedimentación contra tamaño de partícula, espera una curva **creciente y no lineal** (más empinada a medida que crece el tamaño) tanto en agua como en la dispersión de CMC — reflejando la dependencia al cuadrado del diámetro. Y comparando ambos medios para un mismo tamaño de arena, espera que la velocidad de sedimentación en CMC sea **notablemente menor** que en agua pura, en toda la gráfica — la curva completa de CMC debería quedar por debajo de la curva de agua, no solo en un punto, confirmando que el efecto de la viscosidad es independiente y se suma al del tamaño de partícula.",
      ].join("\n"),
      keyPoints: [
      ...
      quizQuestions: [
        {
          question: "¿Por qué una suspensión oftálmica necesita partículas mucho más finas que una suspensión oral?",
          solution: "Porque una partícula demasiado grande puede **rayar la córnea** (un tejido muy sensible) cada vez que el párpado parpadea sobre ella; la vía oral es mucho más tolerante al tamaño de partícula.",
        },
        {
          question: "¿Por qué el tamaño de partícula es especialmente crítico en una suspensión parenteral (inyectable)?",
          solution: "Porque una partícula más grande que el capilar sanguíneo más estrecho por el que debe pasar puede **obstruirlo** (embolia) — es un asunto de seguridad, no solo de calidad del producto.",
        },
        {
          question: "En la actividad 4A, ¿con qué dos instrumentos se puede medir el tamaño de partícula, y qué se mide exactamente con el microscopio óptico?",
          solution: "Con **Mastersizer 3000** o **microscopio óptico**. Con el microscopio se mide el **diámetro de proyección de 50 partículas**, anotando además la más pequeña y la más grande.",
        },
        {
          question: "En el microscopio, a 40× cada división del retículo equivale a 2,5 µm. Si una partícula mide 6 divisiones, ¿cuál es su diámetro?",
          solution: "6 × 2,5 µm = **15 µm**.",
        },
        {
          question: "¿Qué es el diámetro medio de volumen/superficie (d_vs), y para qué tipo de fenómenos es el diámetro representativo más adecuado?",
          solution: "d_vs = Σn·d³ / Σn·d² — un diámetro promedio ponderado que da más peso a las partículas grandes. Es el más representativo para **fenómenos de superficie**, como la disolución y la sedimentación.",
        },
        {
          question: "Escribe la ley de Stokes e indica qué representa cada variable.",
          solution: "v = d²(ρₛ − ρₗ)·g / 18·η — **v**: velocidad de sedimentación · **d**: diámetro de partícula · **ρₛ, ρₗ**: densidad del sólido y del líquido · **g**: gravedad · **η**: viscosidad del medio.",
        },
        {
          question: "Si duplicas el diámetro de una partícula (y todo lo demás queda igual), ¿cuánto más rápido sedimenta?",
          solution: "**4 veces más rápido** — la velocidad de sedimentación depende del diámetro al cuadrado (d²), no de forma lineal.",
        },
        {
          question: "¿Por qué la velocidad de sedimentación depende del diámetro al cuadrado y no, por ejemplo, del diámetro al cubo?",
          solution: "Porque compite el **peso** de la partícula (que crece con el volumen, ∝ al cubo del radio) contra la **fricción viscosa** que el líquido opone a su caída (∝ solo al radio, para una esfera). El balance neto de esa competencia da una dependencia del diámetro al cuadrado en la velocidad terminal.",
        },
        {
          question: "¿Qué le pasa a la velocidad de sedimentación de una partícula si aumenta la viscosidad del medio, manteniendo todo lo demás igual?",
          solution: "**Disminuye** — v es inversamente proporcional a η; a mayor viscosidad del medio, más lenta la sedimentación, sin importar el tamaño de partícula.",
        },
        {
          question: "En la actividad 4B, ¿qué rango de tamaños de arena se usa y cuánto se pesa de cada uno?",
          solution: "Arena tamizada en **3–4 rangos de tamaño**, pesando **5,0 g** de cada rango por probeta.",
        },
        {
          question: "¿Cómo se prepara cada probeta en la actividad 4B (volúmenes de agua)?",
          solution: "Los 5,0 g de arena se incorporan con **10 mL de agua** destilada, y se completa a un volumen total de **50 mL**.",
        },
        {
          question: "¿Cuántas veces se mide el tiempo de sedimentación en cada condición, y por qué?",
          solution: "**Por triplicado**, para tener una medida más confiable (reducir el error de la lectura manual del tiempo) antes de promediar y graficar.",
        },
        {
          question: "Después de medir en agua, ¿qué cambio se hace al sistema para la segunda parte de la actividad 4B?",
          solution: "Se retiran por decantación **20 mL** y se reemplazan por **20 mL de dispersión de carboximetilcelulosa (CMC) al 1 %**, un medio más viscoso que el agua.",
        },
        {
          question: "¿Qué es la \"CMC\" que se usa como medio de dispersión en la actividad 4B, y con qué otro concepto del Módulo 2 NO se debe confundir (aunque comparta la misma sigla)?",
          solution: "Es la **carboximetilcelulosa**, un polímero hidrosoluble usado como agente espesante/suspensor. No confundir con la **concentración micelar crítica** del Módulo 2 — son dos conceptos completamente distintos que comparten, por coincidencia, la misma sigla.",
        },
        {
          question: "Escribe la fórmula de la velocidad de sedimentación experimental usada en esta práctica.",
          solution: "v_sed = 1/t, donde **t** es el tiempo promedio (de las réplicas) que tarda el sólido en sedimentar.",
        },
        {
          question: "¿Qué esperarías ver al graficar velocidad de sedimentación vs. tamaño de partícula, tanto en agua como en CMC?",
          solution: "Una curva **creciente y no lineal** (cada vez más empinada a medida que crece el tamaño), reflejando la dependencia cuadrática de la ley de Stokes — no una línea recta.",
        },
        {
          question: "Para un mismo tamaño de arena, ¿esperarías mayor velocidad de sedimentación en agua o en la dispersión de CMC? ¿Por qué?",
          solution: "**En agua** — la CMC aumenta la viscosidad del medio (η), y según la ley de Stokes eso reduce la velocidad de sedimentación para cualquier tamaño de partícula.",
        },
        {
          question: "V/F con justificación: la ley de Stokes es válida para cualquier suspensión, sin importar la concentración de sólido ni el tipo de flujo.",
          solution: "**Falso.** Solo es válida para suspensiones **diluidas**, con partículas **esféricas** no floculadas y en **flujo laminar** (sin turbulencia) — fuera de esas condiciones, la ecuación deja de predecir correctamente la sedimentación.",
        },
        {
          question: "Si dos productos comerciales tienen el mismo principio activo pero uno se formuló para vía tópica y otro para vía oftálmica, ¿cuál esperarías que tenga menor tamaño de partícula medido?",
          solution: "El de vía **oftálmica** — requiere partículas más finas para no dañar la córnea, mientras que la vía tópica tolera partículas más grandes.",
        },
        {
          question: "¿Qué dos variables de la ley de Stokes se están manipulando por separado en las actividades 4A y 4B respectivamente?",
          solution: "La 4A se centra en el efecto del **tamaño de partícula (d)**, comparando productos comerciales entre sí. La 4B manipula tanto el **tamaño (d)** (distintos rangos de arena) como la **viscosidad del medio (η)** (agua vs. CMC 1 %), permitiendo ver el efecto de cada variable por separado.",
        },
        {
          question: "Además de la velocidad de sedimentación, ¿qué otro aspecto de la estabilidad física de una suspensión afecta el tamaño de partícula, según el fundamento de esta práctica?",
          solution: "El **aspecto y la consistencia** del producto terminado, y en general su estabilidad física — partículas más grandes o muy heterogéneas en tamaño tienden a sedimentar y compactarse con más facilidad, afectando la apariencia y la resuspendibilidad.",
        },
      ],
    },
